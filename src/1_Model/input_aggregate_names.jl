...
shock_names = [ :Z, :ZI, :μ, :μw, :A, :Rshock,:Gshock]

state_names = [
    "A", "Z", "ZI", "RB" , "μ", "μw", "σ", "Ylag","qBlag", "Blag",
     "Tlag", "Ilag", "wlag", "qlag", "Clag", "av_tax_ratelag", "τproglag",
    "Glag","Gshock", "Tprogshock", "Rshock", "Sshock"
]
...
control_names = [
    "r", "w", "K", "π" ,"πw", "Y" ,"C", "q",  "N", "mc", "mcw", "u","rRB", "qB", "bankprofits","tauLS","B",
    "Ht", "av_tax_rate", "T", "I", "BD", "BY","TY", "mcww", "G", "τlev", "τprog",
